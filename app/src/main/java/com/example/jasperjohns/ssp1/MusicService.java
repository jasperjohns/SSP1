    ...
    MediaPlayer.OnCompletionListener
    {
        ...
        class serviceRunnable implements Runnable {
            ...
            public void run() {
                ...
                } else if (_intent.getAction().equals(Constants.ACTION.SEEK_ACTION)) {
                    int _seekPosition = _intent.getIntExtra(Constants.MEDIAPLAYER_SEEK_POSITION, 0);
                    mPlayer.seekTo(_seekPosition);
//                    mPlayer.start();
